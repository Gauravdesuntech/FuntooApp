...
//                             <MaterialCommunityIcons name={item.iconName} size={26} color={Colors.black} />
//                             :
//                             <>
//                                 {item.icon == "SimpleLineIcons" ?
//                                     <SimpleLineIcons name={item.iconName} size={26} color={Colors.black} />
//                                     :
//                                     null}
//                             </>
//                         }
...
//                 <Header title="CashFlow" search={false}/>

//                 <FlatList
//                     data={Configs.CashFlow_Details}
//                     keyExtractor={(item, index) => item.id.toString()}
//                     renderItem={this.renderItem}
//                     initialNumToRender={Configs.CashFlow_Details.length}
...
/*
*
*merge cashflow home with funtoo admin cashflow
*
...
//     //         // Do something with the `navigation` object
//     //         _handlePress(navigation, 2, "Transfer");
//     //       },
//     //     })}
//     //   />
//     // </Tab.Navigator>
