    ...
    renderChoosenImage = (type) => {
        ...
        return (
            <SafeAreaView style={{ flex: 1, flexDirection: 'row' }}>
                <View style={{ width: '30%' }}>
                    <Text style={ { marginTop: 10, marginBottom: 10,color:Colors.textColor, } }>{ type == 'vehiclePhoto' ? 'Venue Entrance Photo' : 'Meter Photo' }</Text>
                </View>
                            ...
                            <KeyboardAwareScrollView showsVerticalScrollIndicator={false}>
                                ...
                                {/* <View style={styles.inputContainer}>
                                    ...
                                    <Dropdown
                                        ...
                                        data={[ {id: 'Yes', name: 'Yes'}, {id: 'No', name: 'No'} ]}
                                        ...
                                        labelField="name"
                                        valueField="name"
                                        placeholder={!this.state.venue_reach ? 'Select Category Name' : '...'}
