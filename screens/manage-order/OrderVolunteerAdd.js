        ...
        .then(res => {
            ...
            if(res.is_success) {
                this.setState({
                    ...
                    console.log("Vendor list|>>>>>>>>>>>>>>>",this.state.venders)
                    if(this.state.venders.length == 0) {
                        // show a warning that we need enquery vender first before adding 
                        // volunteer to the event
                        this.setState({
                            showAlertModal: true,
                            alertType: 'Alert',
                            alertMessage: 'Please enquiry vender first'
                        });
                    }
                });
            }
                        ...
                        <KeyboardAwareScrollView>
                            ...
                            <View style={styles.inputContainer}>
                                ...
                                <Dropdown
                                    ...
                                    labelField="name"
                                    valueField="name"
                                    placeholder={!this.state.vender_name ? 'Select Vendor' : '...'}
