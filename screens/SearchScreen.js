...
export default class SearchScreen extends React.Component {
    ...
    Goto = (data) => {
        // console.log("Catagory Item>>>>>>>>", data);
        ...
        if (data.search_type == "tag") {
            ...
            //     id={data.id}
            // />
            this.props.navigation.push("SearchTagScreen", { tagList: [data], tag_id: data.id });
        }
    }
            ...
            <SafeAreaView style={{ flex: 1, backgroundColor: "transparent" }}>
                ...
                <View style={styles.searchModalBody}>
                    <View style={styles.searchFieldBox}>
                        <Ionicons name="search" size={24} style={{}} color={Colors.textColor} />
                        <TextInput
