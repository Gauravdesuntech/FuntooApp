                  ...
                  />
                      ...
                      <View style={{ flex: 1, height: 40 }}>
                          ...
                          <View style={{ flex: 1, height: 65,marginLeft:10}}>
                            <Text style={{color:Colors.black}}>{this.state.catValue.customer_name}</Text>
                            <Text style={{color:Colors.black}}>{this.state.catValue.venue}</Text>
                            <Text style={{color:Colors.black}}>{moment(this.state.catValue.event_start_timestamp).format("DD/MM/YY")}</Text>
                            </View>
                        }
              </TouchableWithoutFeedback>
            </View>
