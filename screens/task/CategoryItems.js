...
class CategoryItems extends React.Component {
    ...
    subCategoryList = (page) => {
        ...
        const adv=extra;
        // console.log("..............................",page)
        subCategoryList(this.props.route.params.catId,user_id,query,adv,page)
        .then((response)=>{
    ...
    filterQuery = (value) => {
        if(value=='clear'){
            this.setState({filter : '', extra : ''},()=>{this.subCategoryList(1)})
        }else if(value== 'extra'){
            this.setState({filter : '', extra : 'extra=advance'},()=>{this.subCategoryList(1)})
        }else{
            this.setState({filter : value, extra : ''},()=>{this.subCategoryList(1)})
        }
        console.log(".............filterQuery............",value)
    }

    onRefresh = () => {
        this.setState({ isFetching: true, data : [] , page : 1 }, () => { this.subCategoryList(1); });
    }
